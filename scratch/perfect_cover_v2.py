...
def main():
    ...
    # We fade the left and right edges for y < 750 (sky area).
    # For y >= 750 (mountain and roots area), we keep it solid (alpha=255) to prevent roots from fading!
    ...
    # Paste the center illustration at x=156, y=0
    ...
    # Starts inside the solid area of the pasted image (x=276 on the left, x=1014 on the right)
    ...
    left_mountain = [
        ...
        (130, 770),
        (200, 745),
        (276, 755), # Seamless connection point
        (276, 1024)
    ]
    ...
    right_mountain = [
        (1014, 1024),
        (1014, 755), # Seamless connection point
        (1090, 745),
        (1160, 765),
        (1230, 735),
        (1290, 770),

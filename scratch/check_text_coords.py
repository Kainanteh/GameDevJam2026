...
def main():
    ...
    # We inspect columns near the center (x = 512) from y = 50 to 350
    # to see where the text glow/pixels actually end.
    # The text letters have bright neon pink colors, for example r > 100, g < 100, b > 100
